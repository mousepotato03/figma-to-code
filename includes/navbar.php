    ...
    <div class="navbar__topbar-container">
      <div class="navbar__actions">
        <button class="navbar__lang-btn" type="button" aria-label="Language selector">
          <img src="assets/icons/world_4484263 1.svg" alt="Language selector" class="navbar__lang-icon" />
        </button>
      </div>
    </div>
  </div>
  ...
  <nav class="navbar__main">
    <div class="navbar__main-container">
      ...
      <a href="home.php" class="navbar__logo-link">
        <img src="assets/icons/logo_nibec_white.svg" alt="NIBEC Logo" class="navbar__logo" />
      </a>
          ...
          <div class="navbar__dropdown">
            <div class="navbar__dropdown-container">
              <div class="navbar__dropdown-info">
                ...
                <p class="navbar__dropdown-desc">Founded on research from Seoul National University's IBEC, NIBEC is a
                  global bio-healthcare leader shaping a healthier future through innovative peptide fusion technology.
                </p>
              </div>
              <ul class="navbar__dropdown-links">
                <li><a href="about-nibec-overview.php"
                    class="navbar__dropdown-link navbar__dropdown-link--active">Overview</a></li>
                ...
                <li><a href="about-nibec-certifications-compliance.php" class="navbar__dropdown-link">Certifications
                    &amp; Compliance</a></li>
                <li><a href="about-nibec-global-network.php" class="navbar__dropdown-link">Global Network</a></li>
              </ul>
            </div>
          </div>
        </li>
          ...
          <div class="navbar__dropdown">
            <div class="navbar__dropdown-container">
              <div class="navbar__dropdown-info">
                ...
                <p class="navbar__dropdown-desc">Leveraging our proprietary peptide platform technology, we are
                  developing innovative therapeutics targeting unmet medical needs across multiple disease areas.</p>
              </div>
              <ul class="navbar__dropdown-links">
                <li><a href="drug-discovery-division-core-technology.php"
                    class="navbar__dropdown-link navbar__dropdown-link--active">Core Technology</a></li>
          ...
          <div class="navbar__dropdown">
            <div class="navbar__dropdown-container">
              <div class="navbar__dropdown-info">
                ...
                <p class="navbar__dropdown-desc">Combining peptide technology with collagen expertise, we provide
                  optimal tissue regeneration solutions. We lead global standards in high-performance dental and
                  surgical devices.</p>
              </div>
              <ul class="navbar__dropdown-links">
                <li><a href="medical-device-division-core-technology.php"
                    class="navbar__dropdown-link navbar__dropdown-link--active">Core Technology</a></li>
          ...
          <div class="navbar__dropdown">
            <div class="navbar__dropdown-container">
              <div class="navbar__dropdown-info">
                ...
                <p class="navbar__dropdown-desc">Stay informed with the latest news, press releases, and investor
                  relations updates from NIBEC.</p>
              </div>
              <ul class="navbar__dropdown-links">
                <li><a href="ir-news-pressreleases.php"
                    class="navbar__dropdown-link navbar__dropdown-link--active">Press Releases</a></li>
